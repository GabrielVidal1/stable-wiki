...
:::tip Latent space camera

Stable diffusion is like a camera that can take pictures of the latent space

:::

More seriously stable diffusion is an open-source machine learning technology that can generate images from text.
It has been trained on billions of images.
